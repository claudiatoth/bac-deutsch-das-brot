// ============================================
// SELBSTTEST — Das Brot (BAC germană maternă)
...
const finalTestData = [
    // 📖 Werk (3)
    { type: 'multiple', category: '📖 Werk', question: 'Wer ist der Autor von „Das Brot"?', options: ['Heinrich Böll', 'Wolfgang Borchert', 'Bertolt Brecht', 'Erich Kästner'], correct: 'Wolfgang Borchert', explanation: 'Borchert (1921–1947), Hauptvertreter der Trümmerliteratur.' },
    { type: 'multiple', category: '📖 Werk', question: 'In welche Epoche gehört das Werk?', options: ['Barock', 'Trümmerliteratur (Nachkriegsliteratur)', 'Romantik', 'Aufklärung'], correct: 'Trümmerliteratur (Nachkriegsliteratur)', explanation: 'Kahlschlag-/Trümmerliteratur, 1946 (veröffentlicht 1947).' },
    { type: 'luckentext', category: '📖 Werk', question: 'Ergänze die Gattung:', sentence: 'Borcherts „Das Brot" ist eine <strong>______</strong> (kurze Prosaform mit abruptem Anfang und offenem Schluss).', translation: 'povestire scurtă / schiță', accept: ['kurzgeschichte'], correct: 'Kurzgeschichte', explanation: 'Eine Kurzgeschichte.' },

    // 👥 Figuren (3)
    { type: 'multiple', category: '👥 Figuren', question: 'Wer ist das moralische Zentrum der Geschichte?', options: ['der Mann', 'die Frau', 'ein Nachbar', 'ein Kind'], correct: 'die Frau', explanation: 'Die Frau durchschaut die Lüge und opfert aus Liebe eine eigene Scheibe.' },
    { type: 'luckentext', category: '👥 Figuren', question: 'Ergänze (die Ehe):', sentence: 'Das Ehepaar ist „neununddreißig Jahre <strong>______</strong>".', translation: 'căsătorit', accept: ['verheiratet'], correct: 'verheiratet', explanation: '„…dass er log, nachdem sie neununddreißig Jahre verheiratet waren."' },
    { type: 'multiple', category: '👥 Figuren', question: 'Warum lügt der Mann?', options: ['aus Bosheit', 'aus Hunger und Scham', 'aus Langeweile', 'aus Angst vor Dieben'], correct: 'aus Hunger und Scham', explanation: 'Er hat sich heimlich Brot abgeschnitten und schämt sich.' },

    // 🎯 Themen & 🎭 Motive (3)
    { type: 'multiple', category: '🎯 Themen', question: 'Was ist ein zentrales Thema?', options: ['Heldentum', 'Menschlichkeit und Liebe in der Not', 'Reiselust', 'Naturidylle'], correct: 'Menschlichkeit und Liebe in der Not', explanation: 'Liebe, Würde und Opfer siegen über Hunger und Egoismus.' },
    { type: 'multiple', category: '🎭 Motiv', question: 'Das „Brot" ist …', options: ['ein Dingsymbol (Not und Liebe)', 'eine Stadt', 'ein Fluss', 'ein Fest'], correct: 'ein Dingsymbol (Not und Liebe)', explanation: 'Das zentrale Dingsymbol und der Titel: Überleben, Not — und Liebe/Teilen.' },
    { type: 'luckentext', category: '🎭 Motiv', question: 'Ergänze (das Verschweigen):', sentence: 'Krieg und Hunger werden nie ausdrücklich genannt — dieses bewusste Verschweigen nennt man <strong>______</strong>.', translation: 'omisiune', accept: ['aussparung'], correct: 'Aussparung', explanation: 'Die Aussparung — typisch für die Kurzgeschichte.' },

    // 🏗️ Aufbau (2)
    { type: 'multiple', category: '🏗️ Aufbau', question: 'Wie beginnt die Kurzgeschichte?', options: ['mit einer langen Vorgeschichte', 'unmittelbar (in medias res)', 'mit einem Vorwort', 'mit einem Gedicht'], correct: 'unmittelbar (in medias res)', explanation: '„Plötzlich wachte sie auf. Es war halb drei." — der abrupte Einstieg.' },
    { type: 'multiple', category: '🏗️ Aufbau', question: 'Wie ist der Schluss?', options: ['ein klares Happy End', 'offen und pointiert („vier essen")', 'eine ausformulierte Moral', 'der Tod der Figur'], correct: 'offen und pointiert („vier essen")', explanation: 'Der offene, pointierte Schluss überlässt die Deutung dem Leser.' },

    // 💡 Deutung (2)
    { type: 'luckentext', category: '💡 Deutung', question: 'Ergänze (das Opfer):', sentence: 'Am Ende gibt die Frau ihrem Mann eine vierte <strong>______</strong> Brot und isst selbst weniger.', translation: 'felie', accept: ['scheibe'], correct: 'Scheibe', explanation: '„Du kannst ruhig vier essen." — das stille Opfer.' },
...
function buildFinalTest() {
    ...
    container.innerHTML = `
        <div id="test-intro" class="test-intro">
            ...
            <p>Selbsttest mit <strong>${finalTestData.length} Fragen</strong> über <em>Das Brot</em> (Werk, Figuren, Themen, Motive, Aufbau, Deutung, Schreiben).</p>
